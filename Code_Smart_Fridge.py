...
# Section 4: Product List with all the attributes the different products have [from 108 to 128]
# Section 5: Initialization of the session state to the different input fields [from 129 to 155]
# Section 6: Text and Welcome Messages [from 156 to 206]
# Section 7: User input [from 207 to 501]
# Section 8: Visualization [from 502 to 547]
# Section 9: Interactive Owner and Ownership analysis [from 548 to 582]
# Section 10: User Output on Expiration Overview [from 583 to 632]
# Section 11: Inventory [from 633 to 677]
...
SERVICE_ACCOUNT_FILE = (
    "/Users/ericbangerter/Documents/Universität/5.Semester/CS/Group_project/Final/Fertig/Fridge_Final/projekt-cs-32b2fba1e1ff.json"
)
...
product_details = {
    ...
    "Ham": {"Name": "Ham", "calories": "300", "Expiring_Days": 5},
    "Yogurt": {"Name": "Yogurt", "calories": "100", "Expiring_Days": 10},
    "Cheese": {"Name": "Cheese", "calories": "400", "Expiring_Days": 15},
    "Cream": {"Name": "Cream", "calories": "250", "Expiring_Days": 12},
    "Pepper": {"Name": "Pepper", "calories": "50", "Expiring_Days": 10},
    "Sausage": {"Name": "Sausage", "calories": "500", "Expiring_Days": 8},
    "Carrots": {"Name": "Carrots", "calories": "40", "Expiring_Days": 14},
    "Cucumber": {"Name": "Cucumber", "calories": "20", "Expiring_Days": 7},
    "Chocolate": {"Name": "Chocolate", "calories": "500", "Expiring_Days": 30},
    "Cake": {"Name": "Cake", "calories": "500", "Expiring_Days": 7},
    "Butter": {"Name": "Butter", "calories": "750", "Expiring_Days": 14},
    "Apple": {"Name": "Apple", "calories": "50", "Expiring_Days": 10},
    "Strawberries": {"Name": "Strawberries", "calories": "150", "Expiring_Days": 5},
    "Salad": {"Name": "Salad", "calories": "150", "Expiring_Days": 3},
    "Fondue": {"Name": "Fondue", "calories": "800", "Expiring_Days": 10},
}
